      ...
      success: res => {
        ...
        wx.getUserInfo({
          success: res => {
            ...
            this.globalData.userInfo.avatar = data.avatar || res.userInfo.avatarUrl;
            this.globalData.userInfo.nickname = data.nickname || res.userInfo.nickName;
            this.globalData.userInfo.city = res.userInfo.city;
            this.globalData.userInfo.country = res.userInfo.country;
            this.globalData.userInfo.gender = data.gender || res.userInfo.gender;
    ...
    wx.login({
      success: res => {
        ...
        util.comPOST({
          ...
          success: res => {
            this.getUserInfo(res.data.resultData);
            this.globalData.userInfo = Object.assign(this.globalData.userInfo, res.data.resultData);
